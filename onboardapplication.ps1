...
$applicationpassword = "P@ssW0rD!"
$applicationaddress =  "dbservername"
$applicationusername = "dbappuser"
$applicationsafe = "application1"
$applicationplatform = "AzureWindowsServerAccounts"
...
##########################################################
  ...
  $newAccount.platformID = $applicationplatform
